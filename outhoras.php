...
function selectdia($vparam,$expexcel = 0) {
   ...
   // echo $vhasta;
    ...
    $sselect = "SELECT NOMBREP,PREFIJO,POSDECIMAL,COLOR,VALOR,DATE_FORMAT(FLECTURA,'%H') AS HORA,LECTURA AS FECHA FROM vgrafica ";
...
function selectmes($vparam,$expexcel = 0) {
    ...
    //echo $vhasta;
    // Usar vista unión parametros_server y lectura_parametros
    $sselect = "SELECT NOMBREP,PREFIJO,POSDECIMAL,COLOR,VALOR,DIA AS HORA,LECTURA AS FECHA  FROM vgrafica ";
    // Controlar si es para exportar
    if ($expexcel == 1) {
...
function selectyear($vparam,$expexcel = 0) {
    ...
    // Usar vista unión parametros_server y lectura_parametros
    $sselect = "SELECT NOMBREP,PREFIJO,POSDECIMAL,COLOR,VALOR,MES as HORA,LECTURA AS FECHA FROM vgrafica ";
    // Controlar si es para exportar
    if ($expexcel == 1) {
...
function selectall($vparam,$expexcel = 0) {
    ...
    // Formato de fecha estandar yyyy-mm-dd HH:mm:ss
    // Usar vista unión parametros_server y lectura_parametros
    $sselect = "SELECT NOMBREP,PREFIJO,POSDECIMAL,COLOR,VALOR,YEAR as HORA,LECTURA AS FECHA FROM vgrafica ";
    // Controlar si es para exportar
    if ($expexcel == 1) {
